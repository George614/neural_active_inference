...
ax1.scatter([1, 2, 3], [prior_2_target_1st, prior_1_target_1st, prior_0_target_1st], marker="*", label='target_1st_order')
ax1.scatter([1, 2, 3], [prior_2_target_act, prior_1_target_act, prior_0_target_act], marker="_", label='target_actual_mean')
ax1.scatter([1, 2, 3], [prior_2_agent, prior_1_agent, prior_0_agent], marker=".", label='subject mean')
ax1.set_ylabel('Time (s)')
ax1.set_xticklabels(['', '8.18', '9.47', '11.25'])
ax1.set_xlabel('Prior function')
ax2.scatter([1, 2, 3], [agent_2_target_1st, agent_1_target_1st, agent_0_target_1st], marker="*")
ax2.scatter([1, 2, 3], [agent_2_target_act, agent_1_target_act, agent_0_target_act], marker="_")
ax2.scatter([1, 2, 3], [agent_2_agent, agent_1_agent, agent_0_agent], marker=".")
