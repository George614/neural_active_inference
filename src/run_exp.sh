...
sbatch -J ${baseJobName} -o "RC_generated_log_file.o" -e "RC_generated_error_file.e" --mem=8G --cpus-per-task=4 -p tier3 -A actinf --gres=gpu:p4:1 -t 1-0:0:0 command.lock