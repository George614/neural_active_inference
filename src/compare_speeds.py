...
if __name__ == "__main__":
    ...
    agent1_speeds, required_speeds1, first_order_speeds1, succeed1, dist_list1 = record_speeds(target_speed_idx, env, qaiModel=qaiModel)
    ...
    qaiModel = load_AIF_agent(0, 2950, model_save_path)
    agent2_speeds, required_speeds2, first_order_speeds2, succeed2, dist_list2 = record_speeds(target_speed_idx, env2, qaiModel=qaiModel)
    ...
    fig.savefig(os.getcwd() + "/speeds_compare_speedIdx_{}_{}.png".format(target_speed_idx, time.time_ns()//int(1e9)), dpi=200, bbox_inches="tight")